...
const InstagramFeedEmbed = ({ url }: { url: string }) => {
	...
	const username = useMemo(() => {
		...
		return last(compact(pathname.split("/")));
	}, [url]);
...
export const InfluencerSocialList = ({ data }: { data: Creator }) => {
	return (
				...
				<ActionIcon
					onClick={() =>
						modals.open({
							...
							children: (
								<div>
									<InstagramFeedEmbed url={data.instagramHandle!} />
								</div>
							),
						})
					}
